...
mvn install:install-file -Dfile=library/target/lib-french-revolutionary-calendar-$version.jar -Djavadoc=library/target/lib-french-revolutionary-calendar-$version-javadoc.jar -Dsources=library/target/lib-french-revolutionary-calendar-$version-sources.jar
echo "$logprefix: Done."
